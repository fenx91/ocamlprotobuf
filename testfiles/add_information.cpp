...
if ((stu_info.mutable_person(0)->name() == "Amy")) { if ((stu_info.mutable_person(0)->has_registered() && stu_info.mutable_person(0)->registered())) { stu_info.mutable_person(0)->add_grades() ;
int temp ;
int index ;
...
else { cout << "name_does_not_matc" << endl ; } ;
string str ;
